...
export function renderPage(cfg, slug, componentData, components, pageResources) {
    ...
    const doc = (_jsxs("html", { lang: lang, children: [_jsx(Head, { ...componentData }), _jsx("body", { "data-slug": slug, children: _jsxs("div", { id: "quartz-root", class: "page", children: [_jsxs(Body, { ...componentData, children: [LeftComponent, _jsxs("div", { class: "center", children: [_jsxs("div", { class: "page-header", children: [_jsx(Header, { ...componentData, children: header.map((HeaderComponent) => (_jsx(HeaderComponent, { ...componentData }))) }), _jsx("div", { class: "popover-hint", children: beforeBody.map((BodyComponent) => (_jsx(BodyComponent, { ...componentData }))) })] }), _jsx(Content, { ...componentData })] }), RightComponent] }), _jsx(Footer, { ...componentData })] }) }), pageResources.js
